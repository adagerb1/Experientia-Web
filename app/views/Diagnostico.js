    ...
    <section class="section">
      <div class="container">
        ...
        <div class="casos__grid">
          <article class="card" v-for="t in TYPES" :key="t[1]" v-reveal>
            <span class="card__icon" aria-hidden="true">{{ t[0] }}</span>
            <h3 class="card__title">{{ t[1] }}</h3>
            <p class="card__text">{{ t[2] }}</p>
            <p class="caso__sector" style="margin-top:10px">{{ t[3] }}</p>
          </article>
        </div>
      </div>
    </section>
