...
SELECT * FROM (
  ...
  SELECT 'Construir una narrativa de mercado clara.' AS objective, '2026-Q3' AS quarter, 'Conjunto' AS owner, '[{"text":"Piezas con \"Si no tienes tablero, estás reaccionando\"","current":"0","target":"20"},{"text":"Piezas con El Tablero como recurso visual","current":"0","target":"25"},{"text":"CTA único en julio: \"Comenta TABLERO\"","current":"Pendiente","target":"Activo"},{"text":"Piezas colaborativas Tonny + ExperientIA por mes","current":"0","target":"4\/mes"},{"text":"Caso o aplicación real por semana (desde agosto)","current":"0","target":"1\/sem"}]' AS key_results, 0 AS progress, 'activo' AS status, 7 AS position UNION ALL
