...
## Contrato comercial de landing v2
...
- `schema_version=2.0` y `experience_model`.
...
- `checkout` no permite crear inscripciones directas desde el formulario; deriva exclusivamente al enlace de pago verificado.
...
5. Seleccionar **Landing y recorrido de conversión**, responder la guía y generar una versión con contrato v2.
...
- **Área de construcción:** uno de los diez dominios especializados coordinados por AlexIA. Landing y recorrido, seguridad y calidad son obligatorios para publicar; los demás son recomendados según el alcance.
