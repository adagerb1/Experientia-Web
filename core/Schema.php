...
class Schema
{
    private const VERSION = 'q3-2026-04';
    ...
    private static function verified(\PDO $pdo): bool
    {
        try {
            ...
            return $hasConn > 0 && $hasCol > 0 && $hasMetrics > 0 && $hasEvents > 0 && $hasDirection > 0 && $hasEventModule > 0;
    ...
    private static function statements(): array
    {
        ...
        $stmts[] = "CREATE TABLE IF NOT EXISTS event_experiences (
            ...
            summary TEXT NULL, audience TEXT NULL, outcomes_json JSON NULL, owner_id INT UNSIGNED NULL,
        ...
        $stmts[] = "CREATE TABLE IF NOT EXISTS event_offers (
            ...
            checkout_url VARCHAR(500) NULL, active TINYINT(1) NOT NULL DEFAULT 1,
            created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
        ...
        $stmts[] = "CREATE TABLE IF NOT EXISTS event_enrollments (
            ...
            name VARCHAR(180) NOT NULL, email VARCHAR(190) NOT NULL, whatsapp VARCHAR(40) NULL, company VARCHAR(180) NULL,
