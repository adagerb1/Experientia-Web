...
export const api = {
  ...
  alexiaConfig: () => request('/admin/alexia-config'),
  saveAlexiaProfile: (key, data) => request(`/admin/alexia-config/perfiles/${key}`, { method: 'PUT', body: data }),
  saveAlexiaBinding: (channel, endpoint, data) => request(`/admin/alexia-config/canales/${channel}/${endpoint}`, { method: 'PUT', body: data }),
  saveAlexiaKnowledge: (data) => request('/admin/alexia-config/conocimiento', { method: 'POST', body: data }),
  updateAlexiaKnowledge: (id, data) => request(`/admin/alexia-config/conocimiento/${id}`, { method: 'PATCH', body: data }),
  deleteAlexiaKnowledge: (id) => request(`/admin/alexia-config/conocimiento/${id}`, { method: 'DELETE' }),
  saveAlexiaTrigger: (data) => request('/admin/alexia-config/disparadores', { method: 'POST', body: data }),
  updateAlexiaTrigger: (id, data) => request(`/admin/alexia-config/disparadores/${id}`, { method: 'PATCH', body: data }),
  deleteAlexiaTrigger: (id) => request(`/admin/alexia-config/disparadores/${id}`, { method: 'DELETE' }),
  commercialCampaigns: () => request('/admin/campanas'),
  saveCommercialCampaign: (data) => request('/admin/campanas', { method: 'POST', body: data }),
  updateCommercialCampaign: (key, data) => request(`/admin/campanas/${key}`, { method: 'PATCH', body: data }),
  deleteCommercialCampaign: (key) => request(`/admin/campanas/${key}`, { method: 'DELETE' }),
