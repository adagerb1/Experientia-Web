...
import Leads from './views/Leads.js?v=20260727-1';
import Conversaciones from './views/Conversaciones.js?v=20260715-5';
import Eventos from './views/Eventos.js?v=20260727-1';
import TableroDiagnosticos from './views/TableroDiagnosticos.js';
import Pipeline from './views/Pipeline.js?v=20260727-1';
...
import Recursos from './views/Recursos.js?v=20260727-1';
...
import Conectores from './views/Conectores.js?v=20260727-1';
